...
titles = [
	...
	"入門LOGO MINDSTORMS NXT レゴブロックで作る動くロボット",
]
...
isbn_10s = ["48837320088", "4797338253",]
isbn_13s = ["978-48837320088","978-4797338253",]
...
#蔵書データを表示する
titles.size.times {|i| #titleの要素数分添字をiとして処理を繰り返す
	puts "-------------------------"
	puts "書籍名：" + titles[i]
	puts "著書名：" + authors[i]
	puts "よみがな：" + yomies[i]
